...
const ze = (e) => {
  ...
  t.headers = i = A.from(i), t.url = ke(Me(t.baseURL, t.url), e.params, e.paramsSerializer), c && i.set(
    "Authorization",
...
async function An(e) {
  return (await E.post("https://api.socaity.ai/generate", { prompt: e })).data.text;
}
const Jn = {
  generateText: An
};
