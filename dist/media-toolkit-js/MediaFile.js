// src/MediaFile.ts
import { isFileResult } from './types';
...
export class MediaFile {
     ...
     */
    constructor(file_name = "file", content_type = "application/octet-stream") {
    ...
    */
    ...
    async fromFile(filePath) {
        ...
        try {
            ...
            throw new Error(`Failed to load file from path: ${filePath}. ${error.message}`);
        }
    }
    /**
    ...
    fromBytes(data) {
        ...
        if (data instanceof Uint8Array) {
            ...
            this._content = new Uint8Array(data).buffer;
        }
        return this;
    }
    /**
...
export class ImageFile extends MediaFile {
    constructor(file_name = "image", content_type = "image/jpeg") {
