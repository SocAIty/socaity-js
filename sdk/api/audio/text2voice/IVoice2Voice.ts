...
export interface IVoice2Voice extends IAPIClient {
   ...
   * @param source - the embedding, voice name or audio file to convert the audio from.
   * @param options - Additional options for the request
   * @returns TrackedJob that resolves to the cloned voice.
    */
  voice2voice(audio: AudioFile | Array<AudioFile> | string | Array<string>, source?: AudioFile | string, options?: Record<string, any>): Promise<TrackedJob<AudioFile | any>>;
}
